...
<div class="site-content col-12">
    <div class="wpb_column vc_column_container col-12" role="main"">
				...
				<?php while ( $category->have_posts() ) : $category->the_post(); ?>
                    ...
                    <div class="main_container">
                        ...
                        <div class="planet_left">
							...
							$user_liked = $wpdb->get_results( "SELECT userid FROM $wpdb->post_like_table WHERE postid = '$postid'");

							?>

                            <span style="display: none;"><?php
								foreach ($user_liked as $user){
									$user_id = $user->userid;
									$email = $wpdb->get_results( "SELECT user_email FROM $wpdb->users WHERE ID='$user_id'");
									var_dump($email);
								}
								?></span>
